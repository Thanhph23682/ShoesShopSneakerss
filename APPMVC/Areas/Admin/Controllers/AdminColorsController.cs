...
namespace APPMVC.Areas.Admin.Controllers
{
    ...
    public class AdminColorsController : Controller
    {
        ...
        public AdminColorsController(ShopDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Colors != null ? 
                          ...
                          Problem("Entity set 'ShopDbContext.Colors'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ColorID,ColorName,ColorValue")] Color color)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ColorID,ColorName,ColorValue")] Color color)
        {
            if (id != color.ColorID)
            {
                return NotFound();
