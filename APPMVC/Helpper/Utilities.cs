...
namespace FPolyShopSneakers.Helpper
{
    public class Utilities
    {
        ...
        public static async Task<string> UploadFile(IFormFile files, string sDirectory, string newname = null)
        {
            try
            {
                if (newname == null) newname = files.FileName;
